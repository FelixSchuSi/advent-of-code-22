...
def apply_single_step(direction: str, positions):
    ...
    if abs(tail_pos[0] - head_pos[0]) >= 1 and abs(tail_pos[1] - head_pos[1]) >= 1:
        if direction == "U" and not tail_pos[1] == (head_pos[1] + 1):
            tail_pos[0] = head_pos[0]
        elif direction == "D" and not tail_pos[1] == (head_pos[1] - 1):
            tail_pos[0] = head_pos[0]
        elif direction == "R" and not tail_pos[0] == (head_pos[0] + 1):
            tail_pos[1] = head_pos[1]
        elif direction == "L" and not tail_pos[0] == (head_pos[0] - 1):
            tail_pos[1] = head_pos[1]
